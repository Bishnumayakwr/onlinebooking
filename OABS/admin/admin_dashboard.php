...
<body>
  ...
  <div class="container-fluid">
    <nav>
      <ul>
        ...
        <li><a class="btn btn-info" id="view_appointment_requests">Appointment Requests</a></li>
        <li><a class="btn btn-success" id="view_appointments">Appointments</a></li>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      $("#view_appointment_requests").click(function(){
        $("#main_container").load("view_appointment_requests.php");
        });
    });
    $(document).ready(function(){
      $("#view_appointments").click(function(){
        $("#main_container").load("view_appointments.php");
        });
    });
