<?php 
  if(isset($_POST['book_appointment'])){
    ...
    if($noa >= count($time)){
      ...
      $msg = $msg . " Appointment Booking Requested for: " . $_POST['date'] . "/" . $app_hour . " : " . $app_min;
      $app = $app_hour . ":" . $app_min;
      $query = "insert into appointments values(null,'$_POST[name]',$_POST[age],'$_POST[email]',$_POST[mobile],'$_POST[date]','$_POST[time]','$_POST[speciality]','$_POST[doctor]','$app',0,'".date('Y-m-d H:i:s')."')";
...
<body>
  ...
  <div class="container-fluid">
    <marquee class="mt-5"><b>This is an Online Appointment Booking System Project mainly for doctor and patient, where a
        patient can book his or her appointment before visiting the Clinic.</b></marquee>
  </div>
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-6 m-auto">
        ...
        <form action="" method="POST">
          <div class="row">
            <div class="col">
              <input type="text" class="form-control" placeholder="Patient Name" name="name" required pattern="[A-Za-z\s\.]+">
            </div>
            <div class="col">
              <input type="number" class="form-control" placeholder="Patient Age" name="age" required max="120" min="0" step="1">
            </div>
          </div>
          <div class="row mt-3">
            <div class="col">
            ...
            <div class="col">
              <input type="text" class="form-control" placeholder="Mobile No" name="mobile" required maxlength="10" minlength="10">
            </div>
          </div>
          <div class="row mt-3">
            <div class="col">
              <input type="date" class="form-control" placeholder="Select Date" name="date" required min="<?php echo date('Y-m-d'); ?>">
            </div>
            <div class="col">
